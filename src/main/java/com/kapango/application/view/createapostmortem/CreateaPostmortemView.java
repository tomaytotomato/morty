package com.kapango.application.view.createapostmortem;
...
@PageTitle("Create a Postmortem")
@Route(value = "create", layout = MainLayout.class)
@RolesAllowed("USER")
public class CreateaPostmortemView extends Main {

    public CreateaPostmortemView() {
