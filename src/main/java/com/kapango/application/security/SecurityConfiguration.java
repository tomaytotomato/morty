...
import com.kapango.application.view.login.LoginView;
...
public class SecurityConfiguration extends VaadinWebSecurity {
    ...
    @Bean(name = "Global Password Encoder")
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(new AntPathRequestMatcher("/api/*")).permitAll();
